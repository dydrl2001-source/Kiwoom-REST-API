...
docker compose up -d postgres radar-api kiwoom-feed market-regime news-feed dart-feed chart-feed mimosa-engine index-chart-feed research-engine research-engine
